  ...
  return (
    <div className="page-container">
      <div className="success-container">
        ...
        <p className="success-message">You've successfully checked out your {booking.vehicleName}.</p>
            ...
            <div className="detail-row">
              <div className="detail-item full-width">
                ...
                <span className="value instructions">
                  Please return the vehicle to the same station by {booking.returnTime} on {new Date(booking.returnDate).toLocaleDateString()}. 
                  Ensure the vehicle has at least 20% battery charge upon return to avoid additional fees.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="steps-list">
            <div className="step-item">
              ...
              <div className="step-content">
                ...
                <p>Your EV is now ready to drive. Remember to follow all traffic rules and drive safely.</p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                ...
                <p>If you need to charge your vehicle during your rental period, you can use any of our charging stations or public charging networks.</p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                ...
                <p>Return the vehicle to {booking.stationName} by {booking.returnTime} on {new Date(booking.returnDate).toLocaleDateString()}. A staff member will assist you with the return inspection.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="success-actions">
          <Link to="/ev-guide" className="btn secondary">EV Guide & Tips</Link>
