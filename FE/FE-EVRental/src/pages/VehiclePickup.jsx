  ...
  const validateStep = () => {
    ...
    if (step === 1) {
      ...
      if (checkInData.vehiclePhotos.length < 4) {
        newErrors.vehiclePhotos = 'Please upload at least 4 photos (front, back, left, right)';
      }
    ...
    <div className="page-container">
      <div className="pickup-container">
        <div className="breadcrumbs">
          <Link to="/my-bookings">My Bookings</Link> / Vehicle Pickup / Booking #{bookingId}
        </div>
        ...
        <div className="pickup-progress">
          ...
          <div className={`progress-connector ${step > 1 ? 'completed' : ''}`}></div>
          <div className={`progress-step ${step >= 2 ? 'active' : ''} ${step > 2 ? 'completed' : ''}`}>
            <div className="step-number">2</div>
            <div className="step-label">Rental Agreement</div>
          </div>
          <div className={`progress-connector ${step > 2 ? 'completed' : ''}`}></div>
          <div className={`progress-step ${step >= 3 ? 'active' : ''} ${step > 3 ? 'completed' : ''}`}>
            <div className="step-number">3</div>
            <div className="step-label">Vehicle Inspection</div>
          </div>
          <div className={`progress-connector ${step > 3 ? 'completed' : ''}`}></div>
        ...
        <div className="pickup-form-container">
          {step === 1 && (
            <div className="pickup-form">
              ...
              <p>Please present your driver license to the staff member for verification.</p>
              ...
              <div className="form-section">
                <div className="file-upload-container">
                  ...
                  <div className="upload-box">
                    {checkInData.driverLicense ? (
                      <div className="file-preview">
                        <span className="file-name">{checkInData.driverLicense.name}</span>
                      ...
                      <div className="upload-placeholder">
                        ...
                        <div className="upload-text">
                          <span className="primary-text">Scan Driver License</span>
                          <span className="secondary-text">Take a photo or upload file</span>
                        </div>
                      </div>
                    )}
                    <input 
                  ...
                  {errors.driverLicense && <div className="error-message">{errors.driverLicense}</div>}
                </div>
                
                <div className="staff-verification-note">
                  <div className="note-icon">ℹ️</div>
                  <div className="note-text">
                    <strong>Staff verification required:</strong> A staff member will verify your ID in person before proceeding.
                  </div>
                </div>
              </div>
              
              <div className="form-actions">
                <Link to="/my-bookings" className="btn secondary">Cancel</Link>
              ...
              <div className="form-section">
                <div className="rental-agreement">
                  ...
                  <div className="agreement-text">
                    <p>This Rental Agreement (the "Agreement") is entered into between EV Rental Company ("Company") and {user.firstName} {user.lastName} ("Renter") as of {new Date().toLocaleDateString()}.</p>
                    
                    <h4>1. Vehicle Details</h4>
                    <p>The Company agrees to rent to the Renter a {booking.vehicleName} (the "Vehicle") for the period specified in the booking confirmation.</p>
                    
                    <h4>2. Rental Period</h4>
                    <p>From {new Date(booking.pickupDate).toLocaleDateString()} at {booking.pickupTime} to {new Date(booking.returnDate).toLocaleDateString()} at {booking.returnTime}.</p>
                    
                    <h4>3. Payment</h4>
                    <p>The total rental fee is ${booking.price}, payable at the time of pickup.</p>
                    ...
                    <h4>5. Insurance</h4>
                    <p>The rental includes standard insurance coverage. The Renter is responsible for any damages not covered by insurance.</p>
                    
                    <h4>6. Liability</h4>
                    <p>The Renter assumes full responsibility for the vehicle during the rental period. The Company is not liable for any loss or damage to personal property left in the vehicle.</p>
                  </div>
                </div>
                  ...
                  <div className="signature-box">
                    ...
                    <div className="upload-box">
                      {checkInData.signature ? (
                        <div className="file-preview">
                          <span className="file-name">{checkInData.signature.name}</span>
                          <span className="file-size">
                        ...
                        <div className="upload-placeholder">
                          ...
                          <div className="upload-text">
                            <span className="primary-text">Add Your Signature</span>
                            <span className="secondary-text">Draw or upload an image</span>
                          </div>
                        </div>
                      )}
                      <input 
          ...
          {step === 3 && (
            <div className="pickup-form">
              ...
              <p>Please inspect the vehicle with our staff member and document its condition.</p>
              ...
              <div className="form-section">
                <div className="vehicle-photos">
                      ...
                      <div key={index} className="photo-upload-box">
                        {checkInData.vehiclePhotos[index] ? (
                          <div className="photo-preview">
                            <img 
                              src={URL.createObjectURL(checkInData.vehiclePhotos[index])} 
                          ...
                          <>
                            <div className="upload-placeholder">
                              ...
                              <div className="photo-label">
                                {index === 0 ? 'Front' : index === 1 ? 'Back' : index === 2 ? 'Left' : 'Right'}
                              </div>
                            </div>
                            <input 
                              type="file" 
                  ...
                  {errors.vehiclePhotos && <div className="error-message">{errors.vehiclePhotos}</div>}
                </div>
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input 
                        ...
                        min="0"
                      />
                      {errors.initialOdometer && <div className="error-message">{errors.initialOdometer}</div>}
                    </div>
                    
                    <div className="form-group">
                      <label htmlFor="initialBatteryLevel">Initial Battery Level (%)</label>
                      <input 
                        type="number" 
                        ...
                        max="100"
                      />
                      {errors.initialBatteryLevel && <div className="error-message">{errors.initialBatteryLevel}</div>}
                    </div>
                  </div>
                </div>
              </div>
          ...
          {step === 4 && (
            <div className="pickup-form">
              ...
              <p>Please review all information and confirm your vehicle pickup.</p>
                ...
                <div className="pickup-summary">
                  ...
                  <div className="summary-section">
                    ...
                    <div className="summary-item">
                      ...
                      <span className="value">{checkInData.initialOdometer} km</span>
                    </div>
                    <div className="summary-item">
                      <span className="label">Battery Level:</span>
                      <span className="value">{checkInData.initialBatteryLevel}%</span>
                    </div>
                  </div>
                  ...
                  <div className="summary-note">
                    ...
                    <div className="note-text">
                      <strong>Important:</strong> By clicking "Complete Pickup", you confirm that all information is correct and that you have received the vehicle in the condition documented.
                    </div>
                  </div>
