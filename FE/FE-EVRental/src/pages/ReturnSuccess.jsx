...
const mockBookings = {
  ...
  'BK100002': {
    ...
    finalBatteryLevel: 15,
    additionalServices: [],
    extraCharges: {
      lateFee: 0,
      damageFee: 0,
      cleaningFee: 0,
      lowBatteryFee: 25, // Low battery fee applied
      total: 25
    },
    totalAmount: 125
  }
    ...
    return (
      <div className="return-container">
        <div className="not-found-container">
          ...
          <Link to="/my-bookings" className="btn primary">Go to My Bookings</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="page-container">
      <div className="success-container">
        ...
        <p className="success-message">
          You have successfully returned your vehicle. Thank you for choosing our service!
        </p>
          ...
          <div className="card-body">
            ...
            <div className="detail-row">
              ...
              <div className="detail-item">
                ...
                <span className="value">${booking.extraCharges.total.toFixed(2)}</span>
              </div>
            </div>
                  ...
                  <div className="charges-breakdown">
                    ...
                    {booking.extraCharges.damageFee > 0 && (
                      <div className="charge-item">
                        ...
                        <span>${booking.extraCharges.damageFee.toFixed(2)}</span>
                      </div>
                    )}
                    {booking.extraCharges.cleaningFee > 0 && (
                      <div className="charge-item">
                        <span>Cleaning Fee:</span>
                        <span>${booking.extraCharges.cleaningFee.toFixed(2)}</span>
                      </div>
                    )}
                    {booking.extraCharges.lowBatteryFee > 0 && (
                      <div className="charge-item">
                        <span>Low Battery Fee:</span>
                        <span>${booking.extraCharges.lowBatteryFee.toFixed(2)}</span>
                      </div>
                    )}
                  </div>
                </div>
          ...
          <div className="steps-list">
            <div className="step-item">
              ...
              <div className="step-content">
                <h3>Your Receipt</h3>
                <p>A receipt has been sent to your email address. You can also view your rental history and receipts in your account dashboard.</p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                <h3>Feedback</h3>
                <p>Your feedback helps us improve. Please take a moment to rate your overall experience with our service.</p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                <h3>Book Again</h3>
                <p>Planning another trip? We offer discounts for returning customers. Check out our latest EV models and promotions.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="success-actions">
          ...
          <Link to="/book" className="btn primary">Book Another Vehicle</Link>
        </div>
      </div>
    </div>
  );
