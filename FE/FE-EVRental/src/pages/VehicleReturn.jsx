...
export default function VehicleReturn() {
  ...
  useEffect(() => {
    if (booking && finalOdometer && finalBatteryLevel) {
      ...
      const now = new Date();
      const returnDate = new Date(booking.returnDate + 'T' + booking.returnTime);
      if (now > returnDate) {
  ...
  }, [booking, finalOdometer, finalBatteryLevel, damageReported, cleanlinessRating]);
  ...
  const handleNextStep = () => {
    if (currentStep === 1) {
      ...
      if (booking && parseInt(finalOdometer) < booking.initialOdometer) {
        setError('Final odometer reading cannot be less than the initial reading.');
        return;
      }
    }
    ...
    return (
      <div className="return-container">
        <div className="not-found-container">
          ...
          <p>We couldn't find the booking you're looking for. Please check the booking ID and try again.</p>
  ...
  const distanceTraveled = finalOdometer ? (finalOdometer - booking.initialOdometer) : 0;
  const batteryUsed = booking.initialBatteryLevel - (finalBatteryLevel || 0);
  
  return (
    <div className="return-container">
      <div className="breadcrumbs">
        <Link to="/dashboard">Dashboard</Link> &gt; <Link to="/bookings">Bookings</Link> &gt; Vehicle Return
      </div>
      ...
      <div className="booking-summary-card">
        ...
        <div className="booking-details">
          ...
          <div className="detail-item">
            ...
            <span className="value">{new Date(booking.pickupDate).toLocaleDateString()} {booking.pickupTime}</span>
          </div>
          <div className="detail-item">
            <span className="label">Return Time</span>
            <span className="value">{new Date(booking.returnDate).toLocaleDateString()} {booking.returnTime}</span>
          </div>
          <div className="detail-item">
      ...
      <div className="return-form-container">
        ...
        {currentStep === 1 && (
          <div className="return-form">
            ...
            <p>Please take photos of the vehicle from all sides and record the current condition.</p>
              ...
              <div className="vehicle-photos">
                ...
                <div className="photo-grid">
                  ...
                  <div className="photo-upload-box">
                    {vehiclePhotos.front ? (
                      <div className="photo-preview">
                        <img src={URL.createObjectURL(vehiclePhotos.front)} alt="Front" />
                        <button 
                  ...
                  <div className="photo-upload-box">
                    {vehiclePhotos.back ? (
                      <div className="photo-preview">
                        <img src={URL.createObjectURL(vehiclePhotos.back)} alt="Back" />
                        <button 
                          className="remove-photo" 
                  ...
                  <div className="photo-upload-box">
                    {vehiclePhotos.left ? (
                      <div className="photo-preview">
                        <img src={URL.createObjectURL(vehiclePhotos.left)} alt="Left Side" />
                        <button 
                          className="remove-photo" 
                  ...
                  <div className="photo-upload-box">
                    {vehiclePhotos.right ? (
                      <div className="photo-preview">
                        <img src={URL.createObjectURL(vehiclePhotos.right)} alt="Right Side" />
                        <button 
                          className="remove-photo" 
              ...
              <div className="vehicle-condition">
                <div className="form-row">
                  <div className="form-group">
                    ...
                    />
                    {finalOdometer && <div className="input-helper">Distance traveled: {distanceTraveled} km</div>}
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input 
                      ...
                      max="100"
                    />
                    {finalBatteryLevel < 20 && <div className="input-warning">Low battery fee may apply</div>}
                  </div>
                </div>
                ...
                <div className="rating-group">
                  {[1, 2, 3, 4, 5].map(rating => (
                    <button
                      key={rating}
                      type="button"
                      className={`rating-button ${cleanlinessRating >= rating ? 'active' : ''}`}
        ...
        {currentStep === 3 && (
          <div className="return-form">
            ...
            <p>Please review the information below and confirm your vehicle return.</p>
            ...
            <div className="return-summary">
              <div className="summary-section">
                ...
                <div className="summary-item">
                  ...
                  <span className="value">{damageReported === 'yes' ? 'Yes' : 'No'}</span>
                </div>
                {damageReported === 'yes' && (
              ...
              <div className="summary-section">
                ...
                {extraCharges.lateFee > 0 && (
                  <div className="summary-item extra-charge">
                    ...
                    <span className="value">${extraCharges.lateFee.toFixed(2)}</span>
                  </div>
                )}
                ...
                {extraCharges.damageFee > 0 && (
                  <div className="summary-item extra-charge">
                    ...
                    <span className="value">${extraCharges.damageFee.toFixed(2)}</span>
                  </div>
                )}
                ...
                {extraCharges.cleaningFee > 0 && (
                  <div className="summary-item extra-charge">
                    ...
                    <span className="value">${extraCharges.cleaningFee.toFixed(2)}</span>
                  </div>
                )}
                ...
                {extraCharges.lowBatteryFee > 0 && (
                  <div className="summary-item extra-charge">
                    ...
                    <span className="value">${extraCharges.lowBatteryFee.toFixed(2)}</span>
                  </div>
                )}
                
                <div className="summary-item total">
                  <span className="label">Total</span>
                  <span className="value">${(booking.price + extraCharges.total).toFixed(2)}</span>
                </div>
              </div>
              ...
              {extraCharges.total > 0 && (
                <div className="summary-note">
                  ...
                  <div className="note-text">
                    <strong>Additional charges apply:</strong> The final amount includes extra charges based on the condition and timing of your return.
                  </div>
                </div>
              )}
            </div>
