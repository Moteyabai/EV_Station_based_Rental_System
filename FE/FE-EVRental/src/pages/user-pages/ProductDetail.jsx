...
export default function ProductDetail() {
    ...
    async function loadVehicle() {
      try {
        ...
        const mappedVehicle = {
          ...
          priceUnit: "/ngày",
          category: "scooter",
          short: `${bikeData.brandName || bikeData.BrandName || "Xe di?n"} - S? lu?ng có s?n: ${quantity}`,
          description:
            bikeData.description ||
            bikeData.Description ||
            "Không có mô t? chi ti?t.",
          quantity: quantity,
          ...
          statusText: isAvailable ? "Có s?n" : "H?t xe",
        ...
        if (isMounted) {
          setError("Không th? t?i thông tin xe. Vui lòng th? l?i sau.");
          setVehicle(null);
        }
      } finally {
        if (isMounted) {
      ...
      <div className="product-detail">
        <div className="container">
          <div className="loading-message">
            <h2>?? Ðang t?i thông tin xe...</h2>
            <p>Vui lòng d?i trong giây lát.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (!vehicle) {
    return (
      <div className="product-not-found">
        <div className="container">
          <h2>Không tìm th?y xe</h2>
          <p>Xe b?n dang tìm không t?n t?i ho?c dã b? xóa.</p>
  ...
  const handleBookingSubmit = async (formData, rentalDetails) => {
    try {
      ...
      console.error("L?i khi thêm vào gi? hàng:", error);
    }
  };
        ...
        <div className="product-info">
          ...
          <div className="vehicle-status">
            <div className="status-item">
              ...
              <span className="status-label">Tr?ng thái:</span>
              <span
          ...
          <div className="description-section">
            <h3 className="section-title">Mô t? s?n ph?m</h3>
            <p className="section-content">{vehicle.description}</p>
          </div>

          <div className="specs-section">
            <h3 className="section-title">Thông s? k? thu?t</h3>
          ...
          <div className="action-buttons">
            ...
            >
              {vehicle.available ? "?? Thuê ngay" : "? Không có s?n"}
            </button>
            <button
              className="btn btn-secondary cart-btn"
              onClick={() => navigate("/cart")}
            >
              ?? Gi? hàng ({getItemCount()})
            </button>
            <Button
              icon={<StarOutlined />}
        ...
        <div className="success-notification">
          <div className="success-content">
            ...
            <div className="success-message">
              <h4>Ðã thêm vào gi? hàng!</h4>
              <p>Xe {vehicle.name} dã du?c thêm vào gi? hàng c?a b?n.</p>
            </div>
          </div>
        </div>
      )}
