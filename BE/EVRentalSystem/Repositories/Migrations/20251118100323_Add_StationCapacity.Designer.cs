...
namespace Repositories.Migrations
{
    ...
    [Migration("20251118100323_Add_StationCapacity")]
    partial class Add_StationCapacity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Models.Station", b =>
                {
                    ...
                    b.Property<int>("StationCapacity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Models.Refund", b =>
                {
                    b.HasOne("BusinessObject.Models.StationStaff", "StationStaff")
                        .WithMany()
                        .HasForeignKey("ByStaff")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessObject.Models.Payment", "Payment")
                        .WithOne("Refund")
                        .HasForeignKey("BusinessObject.Models.Refund", "PaymentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
